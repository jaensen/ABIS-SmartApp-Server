...
{
    static async ladeRessource(context: DialogContext, ressourceId:number) : Promise<Ressource_1_0_0>
    {
        throw new Error("Not implemented");
    }
    static async ladeBudget(context: DialogContext, budgetId:number) : Promise<Budget_1_0_0>
    {
        throw new Error("Not implemented");
    }

    static async speiseBudget(context: DialogContext, speiseBudget:SpeiseBudget_1_0_0) : Promise<NeueBuchung_1_0_0>
    {
