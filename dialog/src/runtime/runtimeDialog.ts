...
export class RuntimeDialog<TStates extends string, TContext extends IDialogContext>
{
    context:TContext;
    states:RuntimeState<TStates, TContext>[];
    currentState?:RuntimeState<TStates, TContext>

    constructor(build: RuntimeState<TStates, TContext>[], context: TContext)
    {
        this.states = build;
    ...
    async setState(context:TContext, nextStateName:string)
    {
        ...
        let defaultTrigger: RuntimeTrigger<any, any> | undefined;
